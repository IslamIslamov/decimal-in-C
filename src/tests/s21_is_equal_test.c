...
START_TEST(is_equal_5) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  s21_set_power(&val1, 3);
  s21_set_power(&val2, 3);
  ck_assert_int_eq(1, s21_is_equal(val1, val2));
}
END_TEST
...
Suite *suite_is_equal(void) {
  ...
  tcase_add_test(tc, s21_is_equalTest37);
  tcase_add_test(tc, s21_is_equalTest38);
  tcase_add_test(tc, s21_is_equalTest40);
